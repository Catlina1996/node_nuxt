<template>
  <div class="container">
    <div class="form row">
      <nuxt-link class="login" to="/user/login">返回登录</nuxt-link>
      <div class="form-horizontal col-md-offset-3" id="login_form">
        ...
        <div class="col-md-9">
          ...
          <div class="form-group col-md-offset-9">
            <button type="submit" class="btn btn-success pull-right" name="submit" @click="submit()">注册</button>
          </div>
        </div>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      submit() {
        ...
        Cookie.remove('auth');
        this.$axios.post('/regist', data).then(res => {
          console.log(res);
          if(res.status == 200) {
